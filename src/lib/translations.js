export const translations = {
  es: {
    ...
    contact: {
      ...
      description:
        "Estoy disponible para proyectos freelance y oportunidades de colaboración. ¿Tienes una idea? ¡Hablemos!",
      name: "Nombre",
      email: "Email",
      message: "Mensaje",
      send: "Enviar Mensaje",
  ...
  en: {
    ...
    contact: {
      ...
      description:
        "I'm available for freelance projects and collaboration opportunities. Have an idea? Let's talk!",
      name: "Name",
      email: "Email",
      message: "Message",
      send: "Send Message",
