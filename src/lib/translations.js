export const translations = {
  es: {
    ...
    contact: {
      ...
      form: {
        ...
        messageLabel: "Cuéntame sobre tu proyecto",
        messagePlaceholder: "Estoy buscando crear...",
        sending: "Enviando...",
  ...
  en: {
    ...
    contact: {
      ...
      description:
        "Have an innovative idea? Looking to transform your digital presence? I'm available for freelance work and collaborations.",
      ...
      form: {
        ...
        messagePlaceholder: "I'm looking to create...",
        sending: "Sending...",
